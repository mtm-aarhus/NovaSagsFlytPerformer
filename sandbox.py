...
orchestrator_connection = OrchestratorConnection("NovaSagsFlyt",os.getenv("OpenOrchestratorSQL"),os.getenv("OpenOrchestratorKey"),None, None)
orchestrator_connection.log_trace("Running process.")

queue_element = type("QE", (), {})()
queue_element.data = json.dumps({
    "Oprindelig sagsbehandler": "",
    "Ny sagsbehandler": "",
    "Novasagsnummer": ""
})
# --- Queue data ---
